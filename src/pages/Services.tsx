                ...
                return (
                  ...
                  >
                    {/* Per-card category badge removed: every card on this
                        listing shares the same category, so the badge text
                        was redundant. The rotating icon-tile color still
                        gives each card its accent. */}
