...
// Color rotation for service cards — matches OnlineServicesSection vibe
const CARD_ACCENTS = [
  ...
  return (
    <>
      ...
      <Section className="mb-12">
        ...
        {/* Header — matches OnlineServicesSection style */}
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Service cards — matches Transact Online card style */}
